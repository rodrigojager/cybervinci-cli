...
import type { Definition } from "@cybervinci-ai/schema/event"
...
export const CYBERVINCIEvent = event.schema
export type CYBERVINCIEvent = typeof CYBERVINCIEvent.Type
export type CYBERVINCIEventEncoded = typeof CYBERVINCIEvent.Encoded
