...
class Database extends Context.Service<Database, DatabaseShape>()("@cybervinci/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@cybervinci/example/UserStore") {
