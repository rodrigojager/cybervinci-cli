...
beforeAll(async () => {
  ...
  mock.module("@cybervinci-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cybervinci-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cybervinci-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cybervinci-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
