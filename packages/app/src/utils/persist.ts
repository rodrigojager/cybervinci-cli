...
const GLOBAL_STORAGE = "cybervinci.global.dat"
const WINDOW_STORAGE = "cybervinci.window"
const LOCAL_PREFIX = "cybervinci."
...
function workspaceStorage(dir: string) {
  ...
  return `cybervinci.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `cybervinci.draft.${head}.${sum}.dat`
}
