...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: CyberVinciClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: CyberVinciClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: CyberVinciClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => CyberVinciClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, CyberVinciClient>()
