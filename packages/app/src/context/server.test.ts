  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://cybervinci.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://cybervinci.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://cybervinci.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://cybervinci.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://cybervinci.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://cybervinci.example.com"),
      ),
    ).toEqual({
