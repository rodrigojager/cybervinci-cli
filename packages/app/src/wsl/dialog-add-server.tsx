...
import { showToast } from "@cybervinci-ai/ui/toast"
...
import { LoaderV2 } from "@cybervinci-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@cybervinci-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-cybervinci") {
      await run(() => api.installCyberVinci(distro))
      return
    }
