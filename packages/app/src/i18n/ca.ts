export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI Documentació",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra CYBERVINCI s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "CYBERVINCI no respon",
  ...
  "desktop.wsl.error.installCyberVinci": "La instal·lació de CYBERVINCI ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.cybervinciMissing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.cybervinciCannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per CYBERVINCI",
  ...
  "dialog.plugins.empty": "Connectors configurats a cybervinci.json",
  ...
  "dialog.server.description": "Canvia a quin CYBERVINCI servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingCyberVinci": "S'està comprovant OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "S'està registrant CYBERVINCI a {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "S'està actualitzant OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "S'està actualitzant CYBERVINCI a {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Actualitza CYBERVINCI a {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Actualització CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI està llest a {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI està llest.",
  "wsl.onboarding.installCyberVinciIn": "Instal·leu CYBERVINCI a {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instal·la CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que CYBERVINCI pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI no ha pogut verificar WSL en aquesta màquina.",
  ...
  "help.tabs.introduction": "CYBERVINCI L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de CYBERVINCI ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (cybervinci.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que CYBERVINCI encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "CYBERVINCI Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor CYBERVINCI dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu CYBERVINCI al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si CYBERVINCI segueix el tema del sistema, clar o fosc",
