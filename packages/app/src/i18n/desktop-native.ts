...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI failed to load",
  "desktop.recovery.terminated": "CYBERVINCI window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CYBERVINCI is not responding",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.cybervinciMissing": "opencode is not installed in this distro",
  "desktop.wsl.error.cybervinciCannotRun": "opencode is installed but could not run",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
