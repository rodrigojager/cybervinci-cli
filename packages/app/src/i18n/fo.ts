export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI Skjøl",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI valmynd",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI miseydnaðist at heinta",
  "desktop.recovery.terminated": "CYBERVINCI vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "CYBERVINCI svarar ikki",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.cybervinciMissing": "opencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.cybervinciCannotRun": "opencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av CYBERVINCI",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í cybervinci.json",
  ...
  "dialog.server.description": "Skift hvønn CYBERVINCI ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Kanna OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Kanna CYBERVINCI í {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Dagføring OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Dagføring CYBERVINCI í {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Dagfør CYBERVINCI í {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Dagfør CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI er klárt í {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI er klárt.",
  "wsl.onboarding.installCyberVinciIn": "Set CYBERVINCI upp í {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Set upp CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn CYBERVINCI kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani CYBERVINCI aftur.",
  ...
  "help.tabs.introduction": "CYBERVINCI Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av CYBERVINCI ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til CYBERVINCI toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (cybervinci.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, CYBERVINCI stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "CYBERVINCI Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr CYBERVINCI ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu CYBERVINCI sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um CYBERVINCI fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu CYBERVINCI er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá CYBERVINCI byrjar",
