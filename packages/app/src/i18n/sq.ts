export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni CYBERVINCI",
  ...
  "desktop.menu.ariaLabel": "Menuja CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja CYBERVINCI u mbyll papritur",
  "desktop.recovery.unresponsive": "CYBERVINCI nuk po përgjigjet",
  ...
  "desktop.wsl.error.installCyberVinci": "Instalimi i CYBERVINCI dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.cybervinciMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.cybervinciCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i CYBERVINCI përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga CYBERVINCI",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në cybervinci.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server CYBERVINCI lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Po kontrollon OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Po kontrollon CYBERVINCI në {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI po përditësohet...",
  "wsl.onboarding.updatingCyberVinciIn": "Po përditëson CYBERVINCI në {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Përditëso CYBERVINCI në {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Përditëso CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI është gati në {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI është gati.",
  "wsl.onboarding.installCyberVinciIn": "Instaloni CYBERVINCI në {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instaloni CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se CYBERVINCI të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI nuk mund ta verifikonte WSL në këtë makinë.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i CYBERVINCI ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i CYBERVINCI",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (cybervinci.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, CYBERVINCI nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin CYBERVINCI brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket CYBERVINCI në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse CYBERVINCI ndjek temën e sistemit, të lehtë ose të errët",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset CYBERVINCI",
