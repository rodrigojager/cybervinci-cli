...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI 加载失败",
  "desktop.recovery.terminated": "CYBERVINCI 窗口意外终止",
  "desktop.recovery.unresponsive": "CYBERVINCI 未响应",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.cybervinciMissing": "此发行版中未安装 opencode",
  "desktop.wsl.error.cybervinciCannotRun": "已安装 opencode，但无法运行",
  "desktop.wsl.error.cybervinciNotInstalled": "{{distro}} 中未安装 CYBERVINCI",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 cybervinci.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 CYBERVINCI 服务器。",
  ...
  "wsl.onboarding.checkingCyberVinci": "正在检查 CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "正在检查 {{distro}} 中的 CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinci": "正在更新 CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "正在更新 {{distro}} 中的 CYBERVINCI...",
  "wsl.onboarding.updateCyberVinciIn": "更新 {{distro}} 中的 CYBERVINCI。",
  "wsl.onboarding.updateCyberVinci": "更新 CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "{{distro}} 中的 CYBERVINCI 已就绪。",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI 已就绪。",
  "wsl.onboarding.installCyberVinciIn": "在 {{distro}} 中安装 CYBERVINCI。",
  "wsl.onboarding.installCyberVinci": "安装 CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "未安装 CYBERVINCI",
  ...
  "wsl.onboarding.wslNotInstalled.description": "CYBERVINCI 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 CYBERVINCI。",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 CYBERVINCI 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (cybervinci.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：CYBERVINCI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 CYBERVINCI 服务器。",
  ...
  "settings.general.row.language.description": "更改 CYBERVINCI 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 CYBERVINCI 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 CYBERVINCI 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 CYBERVINCI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 CYBERVINCI 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CYBERVINCI。",
