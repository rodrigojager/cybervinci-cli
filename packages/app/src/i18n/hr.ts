...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "CYBERVINCI se nije uspio učitati",
  "Prozor aplikacije CYBERVINCI neočekivano je zatvoren",
  "CYBERVINCI ne reagira",
  ...
  "Instalacija aplikacije CYBERVINCI nije uspjela",
  ...
  "CYBERVINCI nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije CYBERVINCI je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi CYBERVINCI",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u cybervinci.json",
  ...
  "dialog.server.description": "Promijenite na koji se CYBERVINCI poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Provjera OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Provjera CYBERVINCI u {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Ažuriranje OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Ažuriranje CYBERVINCI u {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Ažurirajte CYBERVINCI u {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Ažurirajte CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI je spreman u {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI je spreman.",
  "wsl.onboarding.installCyberVinciIn": "Instalirajte CYBERVINCI u {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instalirajte CYBERVINCI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što CYBERVINCI može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI nije mogao potvrditi WSL na ovom stroju.",
  ...
  "help.tabs.introduction": "Radna površina CYBERVINCI sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CYBERVINCI ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku CYBERVINCI timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (cybervinci.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, CYBERVINCI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "CYBERVINCI Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite CYBERVINCI poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako CYBERVINCI izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li CYBERVINCI slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je CYBERVINCI tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se CYBERVINCI pokrene",
