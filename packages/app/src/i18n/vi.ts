export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "Không tải được CYBERVINCI",
  "desktop.recovery.terminated": "Cửa sổ CYBERVINCI đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CYBERVINCI không phản hồi",
  ...
  "desktop.wsl.error.installCyberVinci": "Không cài đặt được CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.cybervinciMissing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.cybervinciCannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật CYBERVINCI nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do CYBERVINCI cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong cybervinci.json",
  ...
  "dialog.server.description": "Chuyển máy chủ CYBERVINCI mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Đang kiểm tra CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Đang kiểm tra CYBERVINCI trong {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Đang cập nhật CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Đang cập nhật CYBERVINCI trong {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Cập nhật CYBERVINCI trong {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Cập nhật CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI đã sẵn sàng.",
  "wsl.onboarding.installCyberVinciIn": "Cài đặt CYBERVINCI trong {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Cài đặt CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CYBERVINCI có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CYBERVINCI ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CYBERVINCI",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (cybervinci.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CYBERVINCI chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ CYBERVINCI bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CYBERVINCI trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CYBERVINCI tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CYBERVINCI khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CYBERVINCI.",
