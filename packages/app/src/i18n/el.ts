export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI μενού",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "CYBERVINCI το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "CYBERVINCI δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.cybervinciMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.cybervinciCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από CYBERVINCI",
  ...
  "provider.connect.opencodeZen.line1":
    "CYBERVINCI Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο cybervinci.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή CYBERVINCI συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Έλεγχος OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Έλεγχος CYBERVINCI σε {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Ενημέρωση OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Ενημέρωση CYBERVINCI σε {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Ενημέρωση CYBERVINCI σε {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Ενημέρωση CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI είναι έτοιμο.",
  "wsl.onboarding.installCyberVinciIn": "Εγκατάσταση του CYBERVINCI στο {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Εγκατάσταση CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο CYBERVINCI να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  ...
  "help.tabs.introduction": "CYBERVINCI Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του CYBERVINCI ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα CYBERVINCI",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (cybervinci.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το CYBERVINCI δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "CYBERVINCI Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή CYBERVINCI μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του CYBERVINCI στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το CYBERVINCI ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του CYBERVINCI",
