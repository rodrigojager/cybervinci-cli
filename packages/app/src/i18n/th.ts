export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด CYBERVINCI ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง CYBERVINCI หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "CYBERVINCI ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installCyberVinci": "การติดตั้ง CYBERVINCI ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.cybervinciMissing": "ไม่ได้ติดตั้ง opencode ในดิสโทรนี้",
  "desktop.wsl.error.cybervinciCannotRun": "ติดตั้ง opencode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.cybervinciNotInstalled": "ไม่ได้ติดตั้ง CYBERVINCI ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต CYBERVINCI เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CYBERVINCI",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CYBERVINCI",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CYBERVINCI",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน cybervinci.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ CYBERVINCI ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingCyberVinci": "กำลังตรวจสอบ CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "กำลังตรวจสอบ CYBERVINCI ใน {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "กำลังอัปเดต CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "กำลังอัปเดต CYBERVINCI ใน {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "อัปเดต CYBERVINCI ใน {{distro}}",
  "wsl.onboarding.updateCyberVinci": "อัปเดต CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI พร้อมใช้งานแล้ว",
  "wsl.onboarding.installCyberVinciIn": "ติดตั้ง CYBERVINCI ใน {{distro}}",
  "wsl.onboarding.installCyberVinci": "ติดตั้ง CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "ยังไม่ได้ติดตั้ง CYBERVINCI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ CYBERVINCI จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด CYBERVINCI อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ CYBERVINCI Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ CYBERVINCI ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม CYBERVINCI",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (cybervinci.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า CYBERVINCI ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ CYBERVINCI ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ CYBERVINCI บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ CYBERVINCI ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ CYBERVINCI",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ CYBERVINCI เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน CYBERVINCI เวอร์ชันล่าสุด",
