export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap CYBERVINCI ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "CYBERVINCI tidak memberi respons",
  ...
  "desktop.wsl.error.installCyberVinci": "Pemasangan CYBERVINCI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.cybervinciMissing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.cybervinciCannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini CYBERVINCI selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh CYBERVINCI",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam cybervinci.json",
  ...
  "dialog.server.description": "Tukar pelayan CYBERVINCI yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Sedang menyemak OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Sedang menyemak CYBERVINCI dalam {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Sedang mengemas kini OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Sedang mengemas kini CYBERVINCI dalam {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Kemas kini CYBERVINCI dalam {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Kemas kini CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI sedia digunakan.",
  "wsl.onboarding.installCyberVinciIn": "Pasang CYBERVINCI dalam {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Pasang CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CYBERVINCI boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI tidak dapat mengesahkan WSL pada mesin ini.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu CYBERVINCI ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan CYBERVINCI",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (cybervinci.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, CYBERVINCI belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan CYBERVINCI dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa CYBERVINCI pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada CYBERVINCI mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila CYBERVINCI dilancarkan",
