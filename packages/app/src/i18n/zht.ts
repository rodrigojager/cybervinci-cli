...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI 載入失敗",
  "desktop.recovery.terminated": "CYBERVINCI 視窗意外終止",
  "desktop.recovery.unresponsive": "CYBERVINCI 沒有回應",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.cybervinciMissing": "此發行版中未安裝 opencode",
  "desktop.wsl.error.cybervinciCannotRun": "已安裝 opencode，但無法執行",
  "desktop.wsl.error.cybervinciNotInstalled": "{{distro}} 中未安裝 CYBERVINCI",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CYBERVINCI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 cybervinci.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 CYBERVINCI 伺服器。",
  ...
  "wsl.onboarding.checkingCyberVinci": "正在檢查 CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "正在檢查 {{distro}} 中的 CYBERVINCI...",
  ...
  "wsl.onboarding.cybervinciReadyIn": "{{distro}} 中的 CYBERVINCI 已就緒。",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI 已就緒。",
  "wsl.onboarding.installCyberVinciIn": "在 {{distro}} 中安裝 CYBERVINCI。",
  "wsl.onboarding.installCyberVinci": "安裝 CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "未安裝 CYBERVINCI",
  ...
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 CYBERVINCI。",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 CYBERVINCI 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (cybervinci.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：CYBERVINCI 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 CYBERVINCI 伺服器。",
  ...
  "settings.general.row.language.description": "變更 CYBERVINCI 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 CYBERVINCI 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 CYBERVINCI 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 CYBERVINCI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 CYBERVINCI 啟動時自動檢查更新",
