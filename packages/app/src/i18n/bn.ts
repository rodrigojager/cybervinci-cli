export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "CYBERVINCI ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI মেনু",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "CYBERVINCI উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "CYBERVINCI সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.cybervinciMissing": "এই ডিস্ট্রোতে opencode ইনস্টল করা নেই",
  "desktop.wsl.error.cybervinciCannotRun": "opencode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি CYBERVINCI দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং CYBERVINCI-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি CYBERVINCI-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি CYBERVINCI-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "cybervinci.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন CYBERVINCI সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingCyberVinciIn": "{{distro}} এ CYBERVINCI চেক করা হচ্ছে...",
  "wsl.onboarding.updatingCyberVinci": "আপডেট করা হচ্ছে OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "{{distro}}-এ CYBERVINCI আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateCyberVinciIn": "{{distro}}-এ CYBERVINCI আপডেট করুন।",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI আপডেট করুন",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI প্রস্তুত।",
  "wsl.onboarding.installCyberVinciIn": "{{distro}}-এ CYBERVINCI ইনস্টল করুন।",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) CYBERVINCI একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর CYBERVINCI আবার খুলুন।",
  ...
  "help.tabs.introduction": "CYBERVINCI ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি CYBERVINCI টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (cybervinci.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, CYBERVINCI এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "CYBERVINCI ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে CYBERVINCI সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "CYBERVINCI-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে CYBERVINCI কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "CYBERVINCI সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে CYBERVINCI থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি CYBERVINCI এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
