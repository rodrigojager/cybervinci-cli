export const dict = {
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w cybervinci.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (cybervinci.json) nazwy dostawców/modeli",
