export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CYBERVINCI",
  "desktop.recovery.terminated": "Okno CYBERVINCI zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CYBERVINCI nie odpowiada",
  ...
  "desktop.wsl.error.installCyberVinci": "Nie udało się zainstalować CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.cybervinciMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.cybervinciCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CYBERVINCI została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku cybervinci.json",
  ...
  "dialog.server.description": "Przełącz serwer CYBERVINCI, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Sprawdzanie CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Sprawdzanie CYBERVINCI w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Aktualizowanie CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Aktualizowanie CYBERVINCI w dystrybucji {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Zaktualizuj CYBERVINCI w dystrybucji {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Zaktualizuj CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI jest gotowy.",
  "wsl.onboarding.installCyberVinciIn": "Zainstaluj CYBERVINCI w dystrybucji {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Zainstaluj CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CYBERVINCI będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja CYBERVINCI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CYBERVINCI",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (cybervinci.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CYBERVINCI nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CYBERVINCI wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CYBERVINCI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CYBERVINCI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CYBERVINCI.",
