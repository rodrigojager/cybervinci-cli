export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в CYBERVINCI.",
  ...
  "dialog.server.description": "Переключите сервер CYBERVINCI к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в CYBERVINCI требуется WSL (Windows Subsystem for Linux)",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (cybervinci.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что CYBERVINCI пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как CYBERVINCI выглядит на вашем устройстве",
