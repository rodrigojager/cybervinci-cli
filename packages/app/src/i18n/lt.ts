...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "CYBERVINCI įkelti nepavyko",
  "CYBERVINCI langas netikėtai užsidarė",
  "CYBERVINCI neatsako",
  ...
  "CYBERVINCI įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "CYBERVINCI neįdiegtas distributyve {{distro}}",
  "CYBERVINCI naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami CYBERVINCI modeliai",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti cybervinci.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio CYBERVINCI serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Tikrinama OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Tikrinama CYBERVINCI {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Atnaujinamas OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Atnaujinamas CYBERVINCI {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Atnaujinkite CYBERVINCI {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Atnaujinkite CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI yra paruoštas {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI yra paruoštas.",
  "wsl.onboarding.installCyberVinciIn": "Įdiekite CYBERVINCI į {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Įdiekite CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad CYBERVINCI galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI nepavyko patikrinti WSL šiame įrenginyje.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują CYBERVINCI ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą CYBERVINCI komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (cybervinci.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad CYBERVINCI dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "CYBERVINCI darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite CYBERVINCI serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite CYBERVINCI ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip CYBERVINCI atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar CYBERVINCI seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite CYBERVINCI temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią CYBERVINCI versiją.",
