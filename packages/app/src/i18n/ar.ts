export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CYBERVINCI",
  "desktop.recovery.terminated": "توقفت نافذة CYBERVINCI بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CYBERVINCI لا يستجيب",
  ...
  "desktop.wsl.error.installCyberVinci": "فشل تثبيت CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.cybervinciMissing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.cybervinciCannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث CYBERVINCI، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CYBERVINCI.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في cybervinci.json",
  ...
  "dialog.server.description": "تبديل خادم CYBERVINCI الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingCyberVinci": "جارٍ التحقق من CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "جارٍ التحقق من CYBERVINCI في {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "جارٍ تحديث CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "جارٍ تحديث CYBERVINCI في {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "حدّث CYBERVINCI في {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "تحديث CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI جاهز في {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI جاهز.",
  "wsl.onboarding.installCyberVinciIn": "ثبّت CYBERVINCI في {{distro}}.",
  "wsl.onboarding.installCyberVinci": "تثبيت CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CYBERVINCI من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CYBERVINCI التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CYBERVINCI.",
  ...
  "help.tabs.introduction": "أصبح CYBERVINCI Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CYBERVINCI ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CYBERVINCI",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (cybervinci.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CYBERVINCI لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CYBERVINCI نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CYBERVINCI داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CYBERVINCI على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CYBERVINCI يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CYBERVINCI.",
