export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CYBERVINCI.",
  ...
  "toast.update.description": "نسخة جديدة من CYBERVINCI ({{version}}) متاحة الآن للتثبيت.",
