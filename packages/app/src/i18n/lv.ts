export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI dokumentācija",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt CYBERVINCI",
  "desktop.recovery.terminated": "CYBERVINCI logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "CYBERVINCI neatbild",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.cybervinciMissing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.cybervinciCannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no CYBERVINCI",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti cybervinci.json",
  ...
  "dialog.server.description": "Mainiet, pie kura CYBERVINCI servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Pārbaudu OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Pārbaudu CYBERVINCI distribūcijā {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Atjauninu OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Atjauninu CYBERVINCI distribūcijā {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Atjauniniet CYBERVINCI distribūcijā {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Atjauniniet CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI ir gatavs.",
  "wsl.onboarding.installCyberVinciIn": "Instalējiet CYBERVINCI distribūcijā {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instalējiet CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms CYBERVINCI var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet CYBERVINCI no jauna.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna CYBERVINCI versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu CYBERVINCI komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (cybervinci.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, CYBERVINCI vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "CYBERVINCI darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist CYBERVINCI serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt CYBERVINCI saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā CYBERVINCI izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai CYBERVINCI sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet CYBERVINCI tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko CYBERVINCI versiju.",
