export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugin configurati in cybervinci.json",
  ...
  "dialog.server.description": "Cambia il server CYBERVINCI a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Controllo CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Controllo CYBERVINCI in {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Aggiornamento CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Aggiornamento CYBERVINCI in {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Aggiorna CYBERVINCI in {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Aggiorna CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI è pronto in {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI è pronto.",
  "wsl.onboarding.installCyberVinciIn": "Installa CYBERVINCI in {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Installa CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CYBERVINCI possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di CYBERVINCI ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CYBERVINCI",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (cybervinci.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CYBERVINCI non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server CYBERVINCI all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CYBERVINCI sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CYBERVINCI segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CYBERVINCI",
  ...
  "settings.updates.toast.latest.title": "CYBERVINCI è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CYBERVINCI.",
  ...
  "desktop.menu.documentation": "Documentazione di CYBERVINCI",
  ...
  "desktop.menu.ariaLabel": "Menu CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CYBERVINCI",
  "desktop.recovery.terminated": "La finestra di CYBERVINCI si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CYBERVINCI non risponde",
  ...
  "desktop.wsl.error.installCyberVinci": "Installazione di CYBERVINCI non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.cybervinciMissing": "opencode non è installato in questa distribuzione",
  "desktop.wsl.error.cybervinciCannotRun": "opencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CYBERVINCI è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
