...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugins configured in cybervinci.json",
  ...
  "dialog.server.description": "Switch which CYBERVINCI server this app connects to.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Checking CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Checking CYBERVINCI in {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Updating CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Updating CYBERVINCI in {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Update CYBERVINCI in {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Update CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI is ready in {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI is ready.",
  "wsl.onboarding.installCyberVinciIn": "Install CYBERVINCI in {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Install CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CYBERVINCI can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CYBERVINCI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CYBERVINCI team",
  ...
  "error.chain.checkConfig": "Check your config (cybervinci.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CYBERVINCI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CYBERVINCI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CYBERVINCI",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CYBERVINCI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CYBERVINCI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CYBERVINCI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CYBERVINCI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CYBERVINCI.",
