export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans cybervinci.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (cybervinci.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CYBERVINCI ne supporte pas encore l'authentification MCP.",
