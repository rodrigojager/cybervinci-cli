export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CYBERVINCI",
  "desktop.recovery.terminated": "La fenêtre CYBERVINCI s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CYBERVINCI ne répond pas",
  ...
  "desktop.wsl.error.installCyberVinci": "Échec de l'installation d'CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.cybervinciMissing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.cybervinciCannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CYBERVINCI est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans cybervinci.json",
  ...
  "dialog.server.description": "Changez le serveur CYBERVINCI auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Vérification d'CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Vérification d'CYBERVINCI dans {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Mise à jour d'CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Mise à jour d'CYBERVINCI dans {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Mettez à jour CYBERVINCI dans {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Mettre à jour CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI est prêt dans {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI est prêt.",
  "wsl.onboarding.installCyberVinciIn": "Installez CYBERVINCI dans {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Installer CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CYBERVINCI puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'CYBERVINCI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CYBERVINCI",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (cybervinci.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CYBERVINCI ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CYBERVINCI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CYBERVINCI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CYBERVINCI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CYBERVINCI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CYBERVINCI.",
