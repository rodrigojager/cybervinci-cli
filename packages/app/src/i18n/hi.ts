export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI मेन्यू",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI लोड नहीं हो सका",
  "desktop.recovery.terminated": "CYBERVINCI विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "CYBERVINCI प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.cybervinciMissing": "इस डिस्ट्रो में opencode इंस्टॉल नहीं है",
  "desktop.wsl.error.cybervinciCannotRun": "opencode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.cybervinciNotInstalled": "{{distro}} में CYBERVINCI इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और CYBERVINCI में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और CYBERVINCI में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा CYBERVINCI में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन cybervinci.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस CYBERVINCI सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI की जाँच हो रही है...",
  "wsl.onboarding.checkingCyberVinciIn": "{{distro}} में CYBERVINCI की जाँच हो रही है...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI अपडेट हो रहा है...",
  "wsl.onboarding.updatingCyberVinciIn": "{{distro}} में CYBERVINCI अपडेट हो रहा है...",
  "wsl.onboarding.updateCyberVinciIn": "{{distro}} में CYBERVINCI को अपडेट करें।",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI को अपडेट करें",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI {{distro}} में तैयार है।",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI तैयार है।",
  "wsl.onboarding.installCyberVinciIn": "{{distro}} में CYBERVINCI स्थापित करें।",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CYBERVINCI द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर CYBERVINCI को फिर से खोलें।",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट CYBERVINCI टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (cybervinci.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, CYBERVINCI अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर CYBERVINCI सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "CYBERVINCI के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि CYBERVINCI आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि CYBERVINCI सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि CYBERVINCI की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप CYBERVINCI का नवीनतम संस्करण चला रहे हैं।",
