export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI gagal dimuat",
  "desktop.recovery.terminated": "Jendela CYBERVINCI berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "CYBERVINCI tidak merespons",
  ...
  "desktop.wsl.error.installCyberVinci": "Instalasi CYBERVINCI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.cybervinciMissing": "opencode belum terinstal di distro ini",
  "desktop.wsl.error.cybervinciCannotRun": "opencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan CYBERVINCI selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di cybervinci.json",
  ...
  "dialog.server.description": "Ganti server CYBERVINCI mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Memeriksa CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Memeriksa CYBERVINCI di {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Memperbarui CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Memperbarui CYBERVINCI di {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Perbarui CYBERVINCI di {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Perbarui CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI siap di {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI siap.",
  "wsl.onboarding.installCyberVinciIn": "Instal CYBERVINCI di {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instal CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CYBERVINCI dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru CYBERVINCI ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim CYBERVINCI",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (cybervinci.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: CYBERVINCI belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server CYBERVINCI di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan CYBERVINCI di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah CYBERVINCI mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat CYBERVINCI diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru CYBERVINCI.",
