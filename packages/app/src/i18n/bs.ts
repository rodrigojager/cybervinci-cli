export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CYBERVINCI",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI meni",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CYBERVINCI-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CYBERVINCI ne reaguje",
  ...
  "desktop.wsl.error.installCyberVinci": "Instalacija CYBERVINCI-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.cybervinciMissing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.cybervinciCannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje CYBERVINCI-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CYBERVINCI-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CYBERVINCI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CYBERVINCI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u cybervinci.json",
  ...
  "dialog.server.description": "Promijeni na koji se CYBERVINCI server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Provjera CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Provjera CYBERVINCI u distribuciji {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Ažuriranje CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Ažuriranje CYBERVINCI u distribuciji {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Ažuriraj CYBERVINCI u distribuciji {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Ažuriraj CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI je spreman.",
  "wsl.onboarding.installCyberVinciIn": "Instaliraj CYBERVINCI u distribuciji {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instaliraj CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CYBERVINCI mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CYBERVINCI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CYBERVINCI timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (cybervinci.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CYBERVINCI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CYBERVINCI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CYBERVINCI-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CYBERVINCI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CYBERVINCI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CYBERVINCI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CYBERVINCI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CYBERVINCI-a.",
