export const dict = {
  ...
  "dialog.server.description": "Cambiar a qué servidor de CYBERVINCI se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CYBERVINCI",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CYBERVINCI no soporta autenticación MCP todavía.',
