export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de CYBERVINCI",
  ...
  "desktop.menu.ariaLabel": "Menú de CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CYBERVINCI",
  "desktop.recovery.terminated": "La ventana de CYBERVINCI se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CYBERVINCI no responde",
  ...
  "desktop.wsl.error.installCyberVinci": "No se pudo instalar CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.cybervinciMissing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.cybervinciCannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de CYBERVINCI finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugins configurados en cybervinci.json",
  ...
  "dialog.server.description": "Cambiar el servidor de CYBERVINCI al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Comprobando CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Comprobando CYBERVINCI en {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Actualizando CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Actualizando CYBERVINCI en {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Actualiza CYBERVINCI en {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Actualizar CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI está listo en {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI está listo.",
  "wsl.onboarding.installCyberVinciIn": "Instala CYBERVINCI en {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instalar CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CYBERVINCI pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CYBERVINCI.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de CYBERVINCI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CYBERVINCI",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (cybervinci.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CYBERVINCI aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CYBERVINCI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CYBERVINCI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CYBERVINCI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CYBERVINCI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CYBERVINCI.",
