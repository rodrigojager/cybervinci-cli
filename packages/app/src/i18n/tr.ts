...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI yüklenemedi",
  "desktop.recovery.terminated": "CYBERVINCI penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "CYBERVINCI yanıt vermiyor",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.cybervinciMissing": "opencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.cybervinciCannotRun": "opencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CYBERVINCI'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CYBERVINCI'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CYBERVINCI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler cybervinci.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CYBERVINCI sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI kontrol ediliyor...",
  "wsl.onboarding.checkingCyberVinciIn": "{{distro}} içinde CYBERVINCI kontrol ediliyor...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI güncelleniyor...",
  "wsl.onboarding.updatingCyberVinciIn": "{{distro}} içinde CYBERVINCI güncelleniyor...",
  "wsl.onboarding.updateCyberVinciIn": "{{distro}} içindeki CYBERVINCI'u güncelleyin.",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI'u güncelle",
  "wsl.onboarding.cybervinciReadyIn": "{{distro}} içinde CYBERVINCI hazır.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI hazır.",
  "wsl.onboarding.installCyberVinciIn": "CYBERVINCI'u {{distro}} içine kurun.",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI'u kur",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CYBERVINCI'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CYBERVINCI'u tekrar açın.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CYBERVINCI ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (cybervinci.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: CYBERVINCI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CYBERVINCI Masaüstü",
  ...
  "settings.desktop.wsl.description": "CYBERVINCI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CYBERVINCI'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CYBERVINCI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CYBERVINCI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CYBERVINCI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CYBERVINCI'un en son sürümünü kullanıyorsunuz.",
