...
export const dict = {
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CYBERVINCI ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (cybervinci.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CYBERVINCI henüz MCP kimlik doğrulamasını desteklemiyor.',
