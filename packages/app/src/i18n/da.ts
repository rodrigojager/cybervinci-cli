export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i cybervinci.json",
  ...
  "dialog.server.description": "Skift hvilken CYBERVINCI-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Tjekker CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Tjekker CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Opdaterer CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Opdaterer CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Opdater CYBERVINCI i {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Opdater CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CYBERVINCI kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CYBERVINCI igen.",
  ...
  "toast.update.description": "En ny version af CYBERVINCI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CYBERVINCI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (cybervinci.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CYBERVINCI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CYBERVINCI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CYBERVINCI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CYBERVINCI skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CYBERVINCIs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CYBERVINCI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CYBERVINCI.",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI kunne ikke indlæses",
  "desktop.recovery.terminated": "CYBERVINCI-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installCyberVinci": "Installationen af CYBERVINCI mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.cybervinciMissing": "opencode er ikke installeret i denne distribution",
  "desktop.wsl.error.cybervinciCannotRun": "opencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af CYBERVINCI er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
