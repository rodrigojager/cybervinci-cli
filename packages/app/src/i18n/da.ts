export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CYBERVINCI.",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (cybervinci.json) udbyder/modelnavne",
  ...
  "settings.general.row.colorScheme.description": "Vælg om CYBERVINCI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CYBERVINCI er temabestemt.",
