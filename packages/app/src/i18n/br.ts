export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do CYBERVINCI",
  ...
  "desktop.menu.ariaLabel": "Menu do CYBERVINCI",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CYBERVINCI",
  "desktop.recovery.terminated": "A janela do CYBERVINCI foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CYBERVINCI não está respondendo",
  ...
  "desktop.wsl.error.installCyberVinci": "Falha na instalação do CYBERVINCI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.cybervinciMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.cybervinciCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.cybervinciNotInstalled": "O CYBERVINCI não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do CYBERVINCI foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em cybervinci.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CYBERVINCI este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Verificando o CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Verificando o CYBERVINCI em {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Atualizando o CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Atualizando o CYBERVINCI em {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Atualize o CYBERVINCI em {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Atualizar o CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "O CYBERVINCI está pronto em {{distro}}.",
  "wsl.onboarding.cybervinciReady": "O CYBERVINCI está pronto.",
  "wsl.onboarding.installCyberVinciIn": "Instale o CYBERVINCI em {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Instalar o CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CYBERVINCI possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CYBERVINCI não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CYBERVINCI novamente.",
  ...
  "help.tabs.introduction": "Agora, o CYBERVINCI Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do CYBERVINCI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CYBERVINCI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (cybervinci.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CYBERVINCI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CYBERVINCI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Personalize como o CYBERVINCI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CYBERVINCI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CYBERVINCI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CYBERVINCI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CYBERVINCI.",
