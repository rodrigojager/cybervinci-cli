...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CYBERVINCI zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CYBERVINCI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CYBERVINCI zu nutzen.",
  ...
  "dialog.plugins.empty": "In cybervinci.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CYBERVINCI-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI wird geprüft…",
  "wsl.onboarding.checkingCyberVinciIn": "CYBERVINCI in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI wird aktualisiert…",
  "wsl.onboarding.updatingCyberVinciIn": "CYBERVINCI in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateCyberVinciIn": "Aktualisieren Sie CYBERVINCI in {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI aktualisieren",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI ist in {{distro}} bereit.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI ist bereit.",
  "wsl.onboarding.installCyberVinciIn": "Installieren Sie CYBERVINCI in {{distro}}.",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI installieren",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CYBERVINCI einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CYBERVINCI erneut.",
  ...
  "toast.update.description": "Eine neue Version von CYBERVINCI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CYBERVINCI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (cybervinci.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CYBERVINCI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CYBERVINCI mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CYBERVINCI Desktop",
  ...
  "settings.desktop.wsl.description": "CYBERVINCI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CYBERVINCI ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CYBERVINCI auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CYBERVINCI dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CYBERVINCI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CYBERVINCI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CYBERVINCI ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CYBERVINCI wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CYBERVINCI-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CYBERVINCI reagiert nicht",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.cybervinciMissing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.cybervinciCannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das CYBERVINCI-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
