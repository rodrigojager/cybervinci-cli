export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI kunde inte läsas in",
  "desktop.recovery.terminated": "CYBERVINCI-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CYBERVINCI svarar inte",
  ...
  "desktop.wsl.error.installCyberVinci": "Installationen av CYBERVINCI misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.cybervinciMissing": "opencode är inte installerat i den här distributionen",
  "desktop.wsl.error.cybervinciCannotRun": "opencode är installerat men kunde inte köras",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i cybervinci.json",
  ...
  "dialog.server.description": "Växla vilken CYBERVINCI-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Kontrollerar CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Kontrollerar CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Uppdaterar CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Uppdaterar CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Uppdatera CYBERVINCI i {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Uppdatera CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI är redo i {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI är redo.",
  "wsl.onboarding.installCyberVinciIn": "Installera CYBERVINCI i {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Installera CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CYBERVINCI kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CYBERVINCI igen.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av CYBERVINCI ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CYBERVINCI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (cybervinci.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CYBERVINCI stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör CYBERVINCI-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CYBERVINCI ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CYBERVINCI följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CYBERVINCIs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CYBERVINCI startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CYBERVINCI.",
