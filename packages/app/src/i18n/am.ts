export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI መጫን አልቻለም",
  "desktop.recovery.terminated": "CYBERVINCI መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "CYBERVINCI ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCIመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.cybervinciMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.cybervinciCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በCYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCYBERVINCI ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "CYBERVINCI ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCYBERVINCI ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCYBERVINCI ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ cybervinci.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው CYBERVINCI አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingCyberVinci": "መፈተሽ OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "CYBERVINCIን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingCyberVinci": "በማዘመን ላይ OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "በማዘመን ላይ CYBERVINCI በ{{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "አዘምን CYBERVINCI በ{{distro}}።",
  "wsl.onboarding.updateCyberVinci": "አዘምን CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI ዝግጁ ነው።",
  "wsl.onboarding.installCyberVinciIn": "መጫን CYBERVINCI በ{{distro}} ውስጥ።",
  "wsl.onboarding.installCyberVinci": "ጫን CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCIአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) CYBERVINCI WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ CYBERVINCI።",
  ...
  "help.tabs.introduction": "CYBERVINCI ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የCYBERVINCI ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCYBERVINCI ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (cybervinci.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ CYBERVINCI እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "CYBERVINCI ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCYBERVINCI አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCYBERVINCI",
  ...
  "settings.general.row.appearance.description": "CYBERVINCIበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "CYBERVINCI ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "CYBERVINCI ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCYBERVINCI እትም እያሄዱ ነው።",
