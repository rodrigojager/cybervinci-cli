export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI Документация",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът CYBERVINCI приключи неочаквано",
  "desktop.recovery.unresponsive": "CYBERVINCI не отговаря",
  ...
  "desktop.wsl.error.installCyberVinci": "Инсталирането на CYBERVINCI е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.cybervinciMissing": "opencode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.cybervinciCannotRun": "opencode е инсталиран, но не може да стартира",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от CYBERVINCI",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в cybervinci.json",
  ...
  "dialog.server.description": "Превключете към кой CYBERVINCI сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Проверява се OpenCode...",
  "wsl.onboarding.checkingCyberVinciIn": "Проверява се CYBERVINCI в {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Актуализиране на OpenCode...",
  "wsl.onboarding.updatingCyberVinciIn": "Актуализиране на CYBERVINCI в {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Актуализирайте CYBERVINCI в {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Актуализация CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI е готов в {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI е готов.",
  "wsl.onboarding.installCyberVinciIn": "Инсталирайте CYBERVINCI в {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Инсталирайте CYBERVINCI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди CYBERVINCI да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI не можа да провери WSL на тази машина.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на CYBERVINCI ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на CYBERVINCI",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (cybervinci.json).",
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че CYBERVINCI все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра CYBERVINCI вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда CYBERVINCI на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали CYBERVINCI следва системната, светла или тъмна тема",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на CYBERVINCI",
