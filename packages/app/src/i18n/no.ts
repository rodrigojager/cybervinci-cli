...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i cybervinci.json",
  ...
  "settings.general.row.colorScheme.description": "Velg om CYBERVINCI skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CYBERVINCI er tematisert.",
