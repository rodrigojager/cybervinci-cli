...
export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI-meny",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI kunne ikke lastes inn",
  "desktop.recovery.terminated": "CYBERVINCI-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "CYBERVINCI svarer ikke",
  ...
  "desktop.wsl.error.installCyberVinci": "Installasjonen av CYBERVINCI mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.cybervinciMissing": "opencode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.cybervinciCannotRun": "opencode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CYBERVINCI er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CYBERVINCI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CYBERVINCI.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i cybervinci.json",
  ...
  "dialog.server.description": "Bytt hvilken CYBERVINCI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CYBERVINCI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CYBERVINCI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (cybervinci.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CYBERVINCI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CYBERVINCI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CYBERVINCI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CYBERVINCI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CYBERVINCI skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CYBERVINCI.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CYBERVINCI starter",
  ...
  "settings.updates.toast.latest.title": "CYBERVINCI er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CYBERVINCI.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Sjekker CYBERVINCI...",
  "wsl.onboarding.checkingCyberVinciIn": "Sjekker CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Oppdaterer CYBERVINCI...",
  "wsl.onboarding.updatingCyberVinciIn": "Oppdaterer CYBERVINCI i {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Oppdater CYBERVINCI i {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Oppdater CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI er klar i {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI er klar.",
  "wsl.onboarding.installCyberVinciIn": "Installer CYBERVINCI i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CYBERVINCI kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CYBERVINCI på nytt.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
