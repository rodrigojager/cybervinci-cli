export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI-documentatie",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI kan niet worden geladen",
  "desktop.recovery.terminated": "Het CYBERVINCI-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CYBERVINCI reageert niet",
  ...
  "desktop.wsl.error.installCyberVinci": "Installatie van CYBERVINCI is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.cybervinciMissing": "opencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.cybervinciCannotRun": "opencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De CYBERVINCI-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CYBERVINCI te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CYBERVINCI te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CYBERVINCI te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in cybervinci.json",
  ...
  "dialog.server.description": "Wijzig met welke CYBERVINCI-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI controleren...",
  "wsl.onboarding.checkingCyberVinciIn": "CYBERVINCI controleren in {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI bijwerken...",
  "wsl.onboarding.updatingCyberVinciIn": "CYBERVINCI bijwerken in {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Werk CYBERVINCI bij in {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI bijwerken",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI is gereed in {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI is klaar.",
  "wsl.onboarding.installCyberVinciIn": "Installeer CYBERVINCI in {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Installeer CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CYBERVINCI een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CYBERVINCI opnieuw.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CYBERVINCI ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CYBERVINCI-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (cybervinci.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CYBERVINCI ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de CYBERVINCI-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CYBERVINCI",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CYBERVINCI eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CYBERVINCI het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CYBERVINCI aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CYBERVINCI wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CYBERVINCI is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CYBERVINCI.",
