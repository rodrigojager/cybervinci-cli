export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI yüklənə bilmədi",
  "desktop.recovery.terminated": "CYBERVINCI pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CYBERVINCI cavab vermir",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.cybervinciMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.cybervinciCannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CYBERVINCI-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CYBERVINCI-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CYBERVINCI-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər cybervinci.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CYBERVINCI serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI yoxlanılır...",
  "wsl.onboarding.checkingCyberVinciIn": "{{distro}}-də CYBERVINCI yoxlanılır...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI yenilənir...",
  "wsl.onboarding.updatingCyberVinciIn": "{{distro}}-də CYBERVINCI yenilənir...",
  "wsl.onboarding.updateCyberVinciIn": "{{distro}}-də CYBERVINCI-u yeniləyin.",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI-u yeniləyin",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI {{distro}}-də hazırdır.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI hazırdır.",
  "wsl.onboarding.installCyberVinciIn": "CYBERVINCI-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI quraşdırın",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CYBERVINCI WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CYBERVINCI-u yenidən açın.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CYBERVINCI komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (cybervinci.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CYBERVINCI hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində CYBERVINCI serverini işlət.",
  ...
  "settings.general.row.language.description": "CYBERVINCI üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CYBERVINCI-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "CYBERVINCI-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CYBERVINCI-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CYBERVINCI-un ən son versiyasından istifadə edirsiniz.",
