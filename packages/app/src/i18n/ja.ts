export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCIを読み込めませんでした",
  "desktop.recovery.terminated": "CYBERVINCIのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "CYBERVINCIが応答していません",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCIのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.cybervinciMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.cybervinciCannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.cybervinciNotInstalled": "{{distro}}にはCYBERVINCIがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCIのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CYBERVINCIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCYBERVINCIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CYBERVINCIで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "cybervinci.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCYBERVINCIサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCIを確認中...",
  "wsl.onboarding.checkingCyberVinciIn": "{{distro}}内のCYBERVINCIを確認中...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCIを更新中...",
  "wsl.onboarding.updatingCyberVinciIn": "{{distro}}内のCYBERVINCIを更新中...",
  "wsl.onboarding.updateCyberVinciIn": "{{distro}}内のCYBERVINCIを更新してください。",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCIを更新",
  "wsl.onboarding.cybervinciReadyIn": "{{distro}}内のCYBERVINCIの準備ができました。",
  "wsl.onboarding.cybervinciReady": "CYBERVINCIの準備ができました。",
  "wsl.onboarding.installCyberVinciIn": "{{distro}}にCYBERVINCIをインストールしてください。",
  "wsl.onboarding.installCyberVinci": "CYBERVINCIをインストール",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCIがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CYBERVINCIでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、CYBERVINCIをもう一度開いてください。",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCYBERVINCIチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (cybervinci.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CYBERVINCIはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCYBERVINCIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CYBERVINCIの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCYBERVINCIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CYBERVINCIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CYBERVINCIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CYBERVINCI は最新バージョンです。",
