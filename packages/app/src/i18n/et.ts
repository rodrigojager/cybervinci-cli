export const dict = {
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI laadimine ebaõnnestus",
  "desktop.recovery.terminated": "CYBERVINCI aken suleti ootamatult",
  "desktop.recovery.unresponsive": "CYBERVINCI ei vasta",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.cybervinciMissing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.cybervinciCannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub CYBERVINCI",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid CYBERVINCI'is.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis cybervinci.json",
  ...
  "dialog.server.description": "Lülitage, millise CYBERVINCI serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI kontrollimine...",
  "wsl.onboarding.checkingCyberVinciIn": "CYBERVINCI kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI värskendamine...",
  "wsl.onboarding.updatingCyberVinciIn": "CYBERVINCI värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Värskenda CYBERVINCI jaotises {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Värskenda CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI on valmis {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI on valmis.",
  "wsl.onboarding.installCyberVinciIn": "Installige CYBERVINCI asukohta {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Installige CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui CYBERVINCI saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI ei saanud selles masinas kontrollida WSL.",
  ...
  "help.tabs.introduction": "CYBERVINCI Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse CYBERVINCI ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast CYBERVINCI meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (cybervinci.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, CYBERVINCI ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "CYBERVINCI Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage CYBERVINCI server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke CYBERVINCI kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas CYBERVINCI teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas CYBERVINCI järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas CYBERVINCI on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui CYBERVINCI käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse CYBERVINCI uusimat versiooni.",
