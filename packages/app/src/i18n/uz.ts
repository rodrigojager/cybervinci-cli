export const dict = {
  ...
  "desktop.menu.documentation": "CYBERVINCI hujjatlari",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI menyusi",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCI yuklanmadi",
  "desktop.recovery.terminated": "CYBERVINCI oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "CYBERVINCI javob bermayapti",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCI oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.cybervinciMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.cybervinciCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCI {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCI yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCI tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va CYBERVINCI’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va CYBERVINCI da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va CYBERVINCI da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "cybervinci.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi CYBERVINCI serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingCyberVinci": "CYBERVINCI tekshirilmoqda...",
  "wsl.onboarding.checkingCyberVinciIn": "CYBERVINCI {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingCyberVinci": "CYBERVINCI yangilanmoqda...",
  "wsl.onboarding.updatingCyberVinciIn": "CYBERVINCI {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateCyberVinciIn": "CYBERVINCI-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateCyberVinci": "CYBERVINCI-ni yangilang",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI {{distro}} da tayyor.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI tayyor.",
  "wsl.onboarding.installCyberVinciIn": "CYBERVINCI-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installCyberVinci": "CYBERVINCI-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCI o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CYBERVINCI WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra CYBERVINCI-ni qayta oching.",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CYBERVINCI ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida CYBERVINCI jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (cybervinci.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, CYBERVINCI hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "CYBERVINCI bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi CYBERVINCI serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "CYBERVINCI uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "CYBERVINCI qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "CYBERVINCI tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "CYBERVINCI mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "CYBERVINCI ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz CYBERVINCI oxirgi versiyasini ishga tushiryapsiz.",
