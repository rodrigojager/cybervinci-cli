export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "CYBERVINCIn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CYBERVINCIssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CYBERVINCIssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CYBERVINCIssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään cybervinci.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda CYBERVINCI-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingCyberVinci": "Tarkistetaan CYBERVINCIa...",
  "wsl.onboarding.checkingCyberVinciIn": "Tarkistetaan CYBERVINCIa kohteessa {{distro}}...",
  "wsl.onboarding.updatingCyberVinci": "Päivitetään CYBERVINCIa...",
  "wsl.onboarding.updatingCyberVinciIn": "Päivitetään CYBERVINCIa kohteessa {{distro}}...",
  "wsl.onboarding.updateCyberVinciIn": "Päivitä CYBERVINCI jakelussa {{distro}}.",
  "wsl.onboarding.updateCyberVinci": "Päivitä CYBERVINCI",
  "wsl.onboarding.cybervinciReadyIn": "CYBERVINCI on valmis jakelussa {{distro}}.",
  "wsl.onboarding.cybervinciReady": "CYBERVINCI on valmis.",
  "wsl.onboarding.installCyberVinciIn": "Asenna CYBERVINCI jakeluun {{distro}}.",
  "wsl.onboarding.installCyberVinci": "Asenna CYBERVINCI",
  ...
  "wsl.onboarding.distroStatus.cybervinciMissing": "CYBERVINCIa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CYBERVINCI voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CYBERVINCI ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CYBERVINCI uudelleen.",
  ...
  "toast.update.description": "CYBERVINCIn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CYBERVINCI-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (cybervinci.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CYBERVINCI ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "CYBERVINCI sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita CYBERVINCI-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda CYBERVINCIn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CYBERVINCI näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CYBERVINCI järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CYBERVINCIn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CYBERVINCI käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CYBERVINCIn uusinta versiota.",
  ...
  "desktop.menu.documentation": "CYBERVINCI-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CYBERVINCI-valikko",
  ...
  "desktop.recovery.loadFailed": "CYBERVINCIn lataaminen epäonnistui",
  "desktop.recovery.terminated": "CYBERVINCI-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CYBERVINCI ei vastaa",
  ...
  "desktop.wsl.error.installCyberVinci": "CYBERVINCIn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.cybervinciMissing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.cybervinciCannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.cybervinciNotInstalled": "CYBERVINCIa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CYBERVINCIn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "CYBERVINCI Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
