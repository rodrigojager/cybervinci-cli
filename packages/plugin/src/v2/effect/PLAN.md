...
- Effect plugins import `@cybervinci-ai/plugin/v2/effect`, not `@cybervinci-ai/core`.
- Public domain values use generated `@cybervinci-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@cybervinci-ai/plugin/v2/effect`.
