...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CYBERVINCI_CALLER", () => {
    process.env["CYBERVINCI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CYBERVINCI_CALLER", () => {
    process.env["CYBERVINCI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CYBERVINCI_CALLER", () => {
    process.env["CYBERVINCI_CALLER"] = "unknown"
