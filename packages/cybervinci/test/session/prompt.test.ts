...
import { SessionMessageTable } from "@cybervinci-ai/core/session/sql"
...
import { Shell } from "@cybervinci-ai/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@cybervinci-ai/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/cybervinci/src/session/processor.ts")
