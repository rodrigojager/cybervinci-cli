...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      CYBERVINCI_EXPERIMENTAL_WORKSPACES: Flag.CYBERVINCI_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.CYBERVINCI_EXPERIMENTAL_WORKSPACES = original.CYBERVINCI_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
