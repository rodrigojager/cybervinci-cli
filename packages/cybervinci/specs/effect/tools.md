...
Practical reference for the current tool-migration state in `packages/cybervinci`.
...
Tool tests should use the existing Effect helpers in `packages/cybervinci/test/lib/effect.ts`:
