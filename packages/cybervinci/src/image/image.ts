...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CYBERVINCI_PHOTON_WASM_PATH?: string }).__CYBERVINCI_PHOTON_WASM_PATH =
