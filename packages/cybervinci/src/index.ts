...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    if (opts.printLogs) process.env.CYBERVINCI_PRINT_LOGS = "1"
    if (opts.logLevel) process.env.CYBERVINCI_LOG_LEVEL = opts.logLevel
    if (opts.pure) {
