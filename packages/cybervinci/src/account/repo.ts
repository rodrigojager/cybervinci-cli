...
import { AccountStateTable, AccountTable } from "@cybervinci-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/AccountRepo") {}
