 ...
 *   "@cybervinci/ServerAuthConfig",
 *   {
 *     password: Config.string("CYBERVINCI_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CYBERVINCI_SERVER_USERNAME").pipe(Config.withDefault("cybervinci")),
 *   },
 * ) {}
 *
