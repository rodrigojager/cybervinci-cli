...
//
// The saved variant persists across sessions in ~/.local/state/cybervinci/model.json
...
class Service extends Context.Service<Service, VariantService>()("@cybervinci/RunVariant") {}
