...
import { openEditor } from "@cybervinci-ai/tui/editor"
import { registerCyberVinciKeymap } from "@cybervinci-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerCyberVinciKeymap(keymap, renderer, input.tuiConfig)
