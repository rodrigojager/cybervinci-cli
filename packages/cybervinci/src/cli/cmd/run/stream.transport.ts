...
import type { Event, GlobalEvent, CyberVinciClient } from "@cybervinci-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@cybervinci/RunStreamTransport") {}
