...
import { normalizePromptContent } from "@cybervinci-ai/tui/editor"
...
import { CYBERVINCI_BASE_MODE, useBindings } from "@cybervinci-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close CYBERVINCI" } satisfies SlashOption,
    ]
