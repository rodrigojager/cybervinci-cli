...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@cybervinci-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/ToolRegistry") {}
