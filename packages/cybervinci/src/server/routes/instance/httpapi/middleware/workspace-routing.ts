...
>()("@cybervinci/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@cybervinci/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CYBERVINCI_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CYBERVINCI_WORKSPACE_ID) : undefined
}
