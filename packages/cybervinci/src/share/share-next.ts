...
import type * as SDK from "@cybervinci-ai/sdk/v2"
...
import { SessionShareTable } from "@cybervinci-ai/core/share/sql"
...
const disabled = process.env["CYBERVINCI_DISABLE_SHARE"] === "true" || process.env["CYBERVINCI_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/ShareNext") {}
