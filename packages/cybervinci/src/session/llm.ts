...
import { llmClient } from "@cybervinci-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@cybervinci-ai/llm"
import { LLMClient } from "@cybervinci-ai/llm/route"
import type { LLMClientService } from "@cybervinci-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via cybervinci's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @cybervinci-ai/llm. It
