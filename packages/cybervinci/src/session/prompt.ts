...
import { MAX_STEPS_PROMPT } from "@cybervinci-ai/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/SessionPrompt") {}
