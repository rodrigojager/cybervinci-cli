...
import { buildPrompt } from "@cybervinci-ai/core/session/compaction"
import { SessionCompactionEvent } from "@cybervinci-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/SessionCompaction") {}
