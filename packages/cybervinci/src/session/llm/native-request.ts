import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cybervinci-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cybervinci-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cybervinci-ai/llm request objects from cybervinci's session/AI SDK-shaped data.
  return LLM.request({
