...
import { Slug } from "@cybervinci-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@cybervinci-ai/llm"
...
import { locationServiceMapLayer } from "@cybervinci-ai/core/location-services"
...
import { PartTable, SessionTable } from "@cybervinci-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@cybervinci-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".cybervinci", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Session") {}
