...
import { EventSequenceTable, EventTable } from "@cybervinci-ai/core/event/sql"
...
import { WorkspaceEvent } from "@cybervinci-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CYBERVINCI_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CYBERVINCI_WORKSPACE_ID: config.id,
        CYBERVINCI_EXPERIMENTAL_WORKSPACES: "true",
