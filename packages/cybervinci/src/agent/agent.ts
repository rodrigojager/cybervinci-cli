...
import { AbsolutePath, type DeepMutable } from "@cybervinci-ai/core/schema"
...
import { Reference } from "@cybervinci-ai/core/reference"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".cybervinci", "plans", "*.md")]: "allow",
