...
import { ProjectDirectoryTable, ProjectTable } from "@cybervinci-ai/core/project/sql"
...
import { which } from "@cybervinci-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CYBERVINCI_FAKE_VCS)
