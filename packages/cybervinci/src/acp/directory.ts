...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@cybervinci/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@cybervinci/ACPDirectory") {}
