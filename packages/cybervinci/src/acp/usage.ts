...
import type { AssistantMessage as CYBERVINCIAssistantMessage, Message } from "@cybervinci-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@cybervinci-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<CYBERVINCIAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<CYBERVINCIAssistantMessage, "role"> &
  Partial<Pick<CYBERVINCIAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@cybervinci/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@cybervinci/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@cybervinci/ACPUsage") {}
