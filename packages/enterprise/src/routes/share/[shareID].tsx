import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@cybervinci-ai/sdk/v2"
import { SessionTurn } from "@cybervinci-ai/session-ui/session-turn"
import { SessionReview } from "@cybervinci-ai/session-ui/session-review"
import { DataProvider } from "@cybervinci-ai/session-ui/context"
import { FileComponentProvider } from "@cybervinci-ai/ui/context/file"
import { WorkerPoolProvider } from "@cybervinci-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@cybervinci-ai/ui/logo"
import { ProviderIcon } from "@cybervinci-ai/ui/provider-icon"
import { iife } from "@cybervinci-ai/core/util/iife"
...
import { MessageNav } from "@cybervinci-ai/session-ui/message-nav"
import { FileSSR } from "@cybervinci-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@cybervinci-ai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CYBERVINCI</Title>
              </Show>
              <Meta name="description" content="cybervinci - The AI coding agent built for the terminal." />
