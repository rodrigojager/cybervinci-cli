...
export const TypeId: TypeId = "~@cybervinci-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@cybervinci-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@cybervinci-ai/effect-sqlite-node/NodeSqliteClient")
