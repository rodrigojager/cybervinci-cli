...
const en = {
  "app.title": "AI Model Usage Rankings | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "CYBERVINCI Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star CYBERVINCI on GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Try CYBERVINCI",
  ...
  "footer.homeAria": "CYBERVINCI home",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent CYBERVINCI usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} of recent CYBERVINCI usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | CYBERVINCI Data",
  "model.description":
