export const dict = {
  "app.title": "Rankingi użycia modeli AI | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny CYBERVINCI Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę CYBERVINCI na GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Wypróbuj CYBERVINCI",
  ...
  "footer.homeAria": "Strona główna CYBERVINCI",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia CYBERVINCI.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia CYBERVINCI",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów CYBERVINCI z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | CYBERVINCI Data",
  "model.description":
