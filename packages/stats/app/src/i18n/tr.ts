export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde CYBERVINCI Data logosu",
  ...
  "header.githubAria": "GitHub'da CYBERVINCI'a yıldız ver",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "CYBERVINCI'u dene",
  ...
  "footer.homeAria": "CYBERVINCI ana sayfası",
  ...
  "modal.title": "CYBERVINCI Bülteni",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son CYBERVINCI kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "CYBERVINCI'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son CYBERVINCI kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük CYBERVINCI token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | CYBERVINCI Data",
  "model.description":
