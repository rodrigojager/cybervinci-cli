...
export const dict = {
  "app.title": "AI 模型使用排名 | CYBERVINCI 数据",
  "app.description":
    "探索 OpenCode Go 在各 AI 模型上的使用情况，包括 token 用量、排名、市场份额、token 价格、会话成本、缓存比例和地理分布。",
  "app.unfurlAlt": "深色纹理背景上的 CYBERVINCI Data 字标",
  "nav.dataHome": "数据首页",
  "nav.topModels": "热门模型",
  "nav.leaderboard": "排行榜",
  ...
  "header.githubAria": "在 GitHub 上为 CYBERVINCI 加星",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "试用 CYBERVINCI",
  "header.openNav": "打开导航",
  ...
  "lab.title": "{{lab}} AI 模型使用量与排名 | CYBERVINCI 数据",
  "lab.description":
    "比较在 OpenCode Go 中使用的 {{lab}} 模型，包括 token 用量、模型排名、上下文窗口、发布日期、成本和模型专属数据。",
  "lab.loadingTitle": "模型实验室",
  "lab.loadingDescription": "正在读取模型可用性和近期 CYBERVINCI 使用情况。",
  "lab.notFound": "没有匹配此实验室的模型。",
  "lab.heroPrefix": "探索 CYBERVINCI 中使用的 {{count}} 个 {{lab}} 模型",
  ...
  "lab.shareOfUsage": "占近期 CYBERVINCI 使用量的 {{share}}",
  "lab.usageTitle": "{{lab}} token 用量",
  "lab.usageDescription": "过去两个月的每日 CYBERVINCI token 用量。",
  ...
  "lab.usage": "用量",
  "lab.share": "份额",
  "model.title": "{{model}} 使用量、成本与排名 | CYBERVINCI 数据",
  "model.description":
