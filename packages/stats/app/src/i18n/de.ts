export const dict = {
  "app.title": "KI-Modellnutzungs-Rankings | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "CYBERVINCI Data-Wortmarke auf dunklem gemustertem Hintergrund",
  ...
  "header.githubAria": "CYBERVINCI auf GitHub mit Stern markieren",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "CYBERVINCI ausprobieren",
  ...
  "footer.homeAria": "CYBERVINCI-Startseite",
  ...
  "modal.title": "CYBERVINCI-Newsletter",
  ...
  "lab.title": "{{lab}} KI-Modellnutzung und Rankings | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Modellverfügbarkeit und aktuelle CYBERVINCI-Nutzung werden gelesen.",
  "lab.notFound": "Keine Modelle passten zu diesem Lab.",
  "lab.heroPrefix": "Erkunde {{count}} {{lab}}-Modelle, die in CYBERVINCI verwendet werden",
  ...
  "lab.shareOfUsage": "{{share}} der aktuellen CYBERVINCI-Nutzung",
  "lab.usageTitle": "{{lab}}-Tokennutzung",
  "lab.usageDescription": "Tägliches CYBERVINCI-Tokenvolumen der letzten zwei Monate.",
  ...
  "lab.usage": "Nutzung",
  "lab.share": "Anteil",
  "model.title": "{{model}} Nutzung, Kosten und Rang | CYBERVINCI Data",
  "model.description":
