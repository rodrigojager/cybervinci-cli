export const dict = {
  "app.title": "Ranglister for brug af AI-modeller | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "CYBERVINCI Data-ordmærke på en mørk mønstret baggrund",
  ...
  "header.githubAria": "Giv CYBERVINCI en stjerne på GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Prøv CYBERVINCI",
  ...
  "footer.homeAria": "CYBERVINCI-forside",
  ...
  "modal.title": "CYBERVINCI-nyhedsbrev",
  ...
  "lab.title": "{{lab}} AI-modelbrug og ranglister | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Læser modeltilgængelighed og seneste CYBERVINCI-brug.",
  "lab.notFound": "Ingen modeller matchede dette lab.",
  "lab.heroPrefix": "Udforsk {{count}} {{lab}}-modeller brugt i CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} af den seneste CYBERVINCI-brug",
  "lab.usageTitle": "{{lab}}-tokenbrug",
  "lab.usageDescription": "Daglig CYBERVINCI-tokenvolumen over de sidste to måneder.",
  ...
  "lab.usage": "Brug",
  "lab.share": "Andel",
  "model.title": "{{model}} brug, omkostning og rang | CYBERVINCI Data",
  "model.description":
