...
export const dict = {
  ...
  "header.githubAria": "GitHubでCYBERVINCIにスターを付ける",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "CYBERVINCIを試す",
  ...
  "lab.title": "{{lab}} AIモデル使用量とランキング | CYBERVINCIデータ",
  "lab.description":
    "OpenCode Goで使用されている{{lab}}モデルを、トークン使用量、モデルランキング、コンテキストウィンドウ、リリース日、コスト、モデル別データで比較できます。",
  "lab.loadingTitle": "モデルラボ",
  "lab.loadingDescription": "モデルの利用可否と最近のCYBERVINCI使用状況を読み込んでいます。",
  "lab.notFound": "このラボに一致するモデルはありません。",
  "lab.heroPrefix": "CYBERVINCIで使用されている{{count}}件の{{lab}}モデルを確認",
  ...
  "lab.shareOfUsage": "最近のCYBERVINCI使用量の{{share}}",
  "lab.usageTitle": "{{lab}}のトークン使用量",
  "lab.usageDescription": "過去2か月の日次CYBERVINCIトークン量。",
  ...
  "lab.usage": "使用量",
  "lab.share": "シェア",
  "model.title": "{{model}}の使用量、コスト、ランク | CYBERVINCIデータ",
  "model.description":
