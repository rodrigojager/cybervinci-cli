export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel CYBERVINCI Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à CYBERVINCI sur GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Essayer CYBERVINCI",
  ...
  "footer.homeAria": "Accueil CYBERVINCI",
  ...
  "modal.title": "Newsletter CYBERVINCI",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'CYBERVINCI.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'CYBERVINCI",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens CYBERVINCI sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | CYBERVINCI Data",
  "model.description":
