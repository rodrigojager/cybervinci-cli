export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "Словесний знак CYBERVINCI Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку CYBERVINCI на GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Спробувати CYBERVINCI",
  ...
  "footer.homeAria": "Головна CYBERVINCI",
  ...
  "modal.title": "Розсилка CYBERVINCI",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання CYBERVINCI.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання CYBERVINCI",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів CYBERVINCI за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | CYBERVINCI Data",
  "model.description":
