export const dict = {
  "app.title": "Ranking de uso de modelos de IA | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do CYBERVINCI Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao CYBERVINCI no GitHub",
  "header.github": "GitHub",
  "header.tryCYBERVINCI": "Experimente o CYBERVINCI",
  ...
  "footer.homeAria": "Início do CYBERVINCI",
  ...
  "modal.title": "Newsletter do CYBERVINCI",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do CYBERVINCI.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do CYBERVINCI",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do CYBERVINCI nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | CYBERVINCI Data",
  "model.description":
