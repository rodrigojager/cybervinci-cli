export const dict = {
  "app.title": "Rangeringer for bruk av AI-modeller | CYBERVINCI Data",
  "app.description":
  ...
  "app.unfurlAlt": "CYBERVINCI Data-ordmerke på en mørk mønstret bakgrunn",
  ...
  "header.githubAria": "Gi CYBERVINCI en stjerne på GitHub",
  ...
  "modal.title": "CYBERVINCI-nyhetsbrev",
  ...
  "lab.title": "{{lab}} AI-modellbruk og rangeringer | CYBERVINCI Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leser modelltilgjengelighet og nylig CYBERVINCI-bruk.",
  "lab.notFound": "Ingen modeller matchet dette laben.",
  "lab.heroPrefix": "Utforsk {{count}} {{lab}}-modeller brukt i CYBERVINCI",
  ...
  "lab.shareOfUsage": "{{share}} av nylig CYBERVINCI-bruk",
  "lab.usageTitle": "{{lab}} tokenbruk",
  "lab.usageDescription": "Daglig CYBERVINCI-tokenvolum over de siste to månedene.",
  ...
  "lab.usage": "Bruk",
  "lab.share": "Andel",
  "model.title": "{{model}} bruk, kostnad og rangering | CYBERVINCI Data",
  "model.description":
