...
import { isSessionNotFoundError, isUnauthorizedError, CYBERVINCI } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = CYBERVINCI.make({ baseUrl: "http://localhost:3000" })
