...
import { compile, emitEffectImported, emitPromise, write } from "@cybervinci-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "CYBERVINCIEventEncoded",
              import: 'import type { CYBERVINCIEventEncoded } from "@cybervinci-ai/protocol/groups/event"',
            },
          },
        }),
