...
import defaultSoundPath from "@cybervinci-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@cybervinci-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@cybervinci-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@cybervinci-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@cybervinci-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@cybervinci-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "cybervinci"
const DEFAULT_PACK_ID = "cybervinci.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "CYBERVINCI Default",
  builtin: true,
  sounds: {
