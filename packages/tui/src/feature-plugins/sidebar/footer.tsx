import type { TuiPlugin, TuiPluginApi } from "@cybervinci-ai/plugin/tui"
      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>CYBERVINCI includes free models so you can start immediately.</text>
