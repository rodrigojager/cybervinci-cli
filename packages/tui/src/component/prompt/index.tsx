...
import { registerCyberVinciSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@cybervinci-ai/sdk/v2"
...
import { CYBERVINCI_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useCyberVinciKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.CYBERVINCI_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
