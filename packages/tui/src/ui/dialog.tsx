...
import { useBindings, useCyberVinciModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useCyberVinciModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.CYBERVINCI_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
