...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/cybervinci/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/cybervinci (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/cybervinci/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/cybervinci/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CYBERVINCI_DB|CYBERVINCI_DB|CYBERVINCI_DEV|Global\\.Path\\.data|data =" in packages/cybervinci/src (115 matches)',
  },
] as const
