---
title: Serwery LSP
description: CYBERVINCI integruje się z serwerami LSP.
---

CYBERVINCI może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

CYBERVINCI posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
:::note
Możesz wyłączyć automatyczne pobieranie serwerów LSP, ustawiając zmienną środowiskową `CYBERVINCI_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Gdy LSP jest włączony i CYBERVINCI otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji CYBERVINCI.
