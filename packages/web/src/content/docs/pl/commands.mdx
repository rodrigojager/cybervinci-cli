...
Utwórz `.cybervinci/commands/test.md`:
...
Możesz zdefiniować polecenia w `cybervinci.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji cybervinci:
...
- Globalnie: `~/.config/cybervinci/commands/`
- Na projekt: `.cybervinci/commands/`
...
cybervinci zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
