---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące cybervinci.
---

Funkcja udostępniania cybervinci umożliwia tworzenie publicznych linków do konwersacji cybervinci, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, cybervinci:
...
cybervinci obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie cybervinci korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `cybervinci.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu cybervinci w Twojej organizacji.
