---
title: TUI
description: Brug af CYBERVINCI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CYBERVINCI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CYBERVINCI starter TUI for den nuværende mappe.
...
Når du bruger CYBERVINCI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CYBERVINCI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CYBERVINCI. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `cybervinci.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe CYBERVINCI venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `cybervinci.default`.
