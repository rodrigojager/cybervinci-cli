...
description: Brug CYBERVINCI i enhver ACP-kompatibel editor.
---

CYBERVINCI understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge CYBERVINCI via ACP, konfigurer din editor til at køre kommandoen `cybervinci acp`.

Kommandoen starter CYBERVINCI som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'CYBERVINCI'-agent i AI Chat-agentvælgeren.
...
For at bruge CYBERVINCI som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge CYBERVINCI som ACP-agent til chat.
...
CYBERVINCI fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din CYBERVINCI-konfiguration
