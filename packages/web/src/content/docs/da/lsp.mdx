---
title: LSP-servere
description: CYBERVINCI integreres med dine LSP-servere.
---

CYBERVINCI kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

CYBERVINCI leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CYBERVINCI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og cybervinci åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din cybervinci-konfiguration.
