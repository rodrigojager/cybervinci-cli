...
Brug den til at bygge integrasjoner og kontrollere cybervinci programmatisk.
...
Opret en forekomst av cybervinci:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `cybervinci.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av cybervinci, kan du oprete en klientforekomst for at koble til den:
