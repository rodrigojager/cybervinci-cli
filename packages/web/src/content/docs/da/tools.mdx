...
Her er alle de innebygde verktøyene som er tilgængelige i CYBERVINCI.
...
:::note
Dette verktøyet er bare tilgængelig når `CYBERVINCI_EXPERIMENTAL_LSP_TOOL=true` (eller `CYBERVINCI_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger CYBERVINCI-leverandøren eller når miljøvariabelen `CYBERVINCI_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
