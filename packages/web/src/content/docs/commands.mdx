...
Create `.cybervinci/commands/test.md`:
...
You can add custom commands through the CYBERVINCI config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your CYBERVINCI [config](/docs/config):
...
- Per-project: `.cybervinci/commands/`
...
cybervinci includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
