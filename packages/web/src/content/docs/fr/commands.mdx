...
Créez `.cybervinci/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration CYBERVINCI ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre CYBERVINCI [config](/docs/config) :
...
- Par projet : `.cybervinci/commands/`
...
cybervinci comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
