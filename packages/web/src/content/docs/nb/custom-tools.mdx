...
description: Lag verktøy som LLM kan kalle inn CYBERVINCI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med CYBERVINCI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.cybervinci/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/cybervinci/tools/`.
