---
title: ACP-støtte
description: Bruk cybervinci i en hvilken som helst ACP-kompatibel editor.
---

CYBERVINCI støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke CYBERVINCI via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `cybervinci acp`.

Kommandoen starter CYBERVINCI som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'CYBERVINCI'-agenten i AI Chat-agentvelgeren.
...
For å bruke CYBERVINCI som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke CYBERVINCI som ACP-agent for chat.
...
CYBERVINCI fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i CYBERVINCI-konfigurasjonen
