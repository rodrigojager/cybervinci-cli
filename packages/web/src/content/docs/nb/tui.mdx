---
title: TUI
description: Bruke cybervinci-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CYBERVINCI gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CYBERVINCI starter TUI for gjeldende katalog.
...
Når du bruker CYBERVINCI TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CYBERVINCI. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CYBERVINCI. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `cybervinci.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge CYBERVINCI venter etter leader key. Standard er `2000`.
...
Bruk `CYBERVINCI_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `cybervinci.default`.
