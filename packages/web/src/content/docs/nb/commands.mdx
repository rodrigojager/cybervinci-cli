...
Opprett `.cybervinci/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CYBERVINCI-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CYBERVINCI [config](/docs/config):
...
- Per prosjekt: `.cybervinci/commands/`
...
CYBERVINCI inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
