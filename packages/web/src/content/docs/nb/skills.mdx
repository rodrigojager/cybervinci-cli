...
Agentferdigheter lar CYBERVINCI oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
cybervinci søker etter disse stedene:

- Prosjektkonfigurasjon: `.cybervinci/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/cybervinci/skills/<name>/SKILL.md`
...
For prosjektlokale stier går cybervinci opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.cybervinci/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/cybervinci/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.cybervinci/skills/git-release/SKILL.md` slik:
...
cybervinci viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `cybervinci.json`:
...
**For innebygde agenter** (i `cybervinci.json`):
