---
title: LSP-servere
description: cybervinci integreres med LSP-serverne dine.
---

CYBERVINCI kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

CYBERVINCI kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `CYBERVINCI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og cybervinci åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i CYBERVINCI-konfigurasjonen.
