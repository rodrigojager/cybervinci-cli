...
สร้าง `.cybervinci/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CYBERVINCI:
...
- ระดับผู้ใช้ (Global): `~/.config/cybervinci/commands/`
- ระดับโปรเจ็กต์: `.cybervinci/commands/`
...
CYBERVINCI มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
