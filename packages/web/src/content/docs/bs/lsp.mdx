---
title: LSP serveri
description: CYBERVINCI se integriše sa vašim LSP serverima.
---

CYBERVINCI se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

CYBERVINCI dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `CYBERVINCI_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i cybervinci otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj cybervinci konfiguraciji.
