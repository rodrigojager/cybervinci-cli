---
title: ACP podrška
description: Koristite CYBERVINCI u bilo kojem uređivaču kompatibilnom sa ACP.
---

CYBERVINCI podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili CYBERVINCI putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `cybervinci acp`.

Naredba pokreće CYBERVINCI kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "CYBERVINCI" agenta u AI Chat agent selektoru.
...
Da koristite CYBERVINCI kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi CYBERVINCI kao ACP chat agenta.
...
CYBERVINCI radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj CYBERVINCI konfiguraciji
