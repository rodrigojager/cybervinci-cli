...
Kreiraj `.cybervinci/commands/test.md`:
...
Možete dodati prilagođene komande kroz CYBERVINCI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CYBERVINCI [config](/docs/config):
...
- Globalno: `~/.config/cybervinci/commands/`
- Po projektu: `.cybervinci/commands/`
...
CYBERVINCI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
