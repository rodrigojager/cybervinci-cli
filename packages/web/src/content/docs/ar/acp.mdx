---
title: دعم ACP
description: استخدم CYBERVINCI في أي محرر متوافق مع ACP.
---

يدعم CYBERVINCI بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام CYBERVINCI عبر ACP، اضبط محررك ليشغّل الأمر `cybervinci acp`.

يشغّل هذا الأمر CYBERVINCI كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'CYBERVINCI' من محدد الوكلاء في AI Chat.
...
لاستخدام CYBERVINCI كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام CYBERVINCI كوكيل ACP للدردشة.
...
يعمل CYBERVINCI عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات CYBERVINCI
