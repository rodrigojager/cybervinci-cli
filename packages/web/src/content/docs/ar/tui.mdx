---
title: TUI
description: استخدام واجهة المستخدم TUI في CYBERVINCI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CYBERVINCI واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CYBERVINCI إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CYBERVINCI في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CYBERVINCI. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CYBERVINCI. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `cybervinci.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار CYBERVINCI بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `cybervinci.default`.
