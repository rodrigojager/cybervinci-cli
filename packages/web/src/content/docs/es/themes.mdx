...
Con CYBERVINCI puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, CYBERVINCI usa nuestro propio tema `cybervinci`.
...
CYBERVINCI viene con varios temas integrados.
...
- Quiere que CYBERVINCI coincida con la apariencia de su terminal
...
CYBERVINCI admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/cybervinci/themes/*.json` o `$XDG_CONFIG_HOME/cybervinci/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.cybervinci/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.cybervinci/themes/*.json`
