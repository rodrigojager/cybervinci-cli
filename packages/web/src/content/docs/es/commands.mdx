...
Crear `.cybervinci/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CYBERVINCI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CYBERVINCI [config](/docs/config):
...
- Por proyecto: `.cybervinci/commands/`
...
cybervinci incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
