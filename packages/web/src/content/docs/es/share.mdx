---
title: Compartir
description: Comparte tus conversaciones CYBERVINCI.
---

La función para compartir de CYBERVINCI te permite crear enlaces públicos a tus conversaciones de CYBERVINCI, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, CYBERVINCI:
...
CYBERVINCI admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, CYBERVINCI usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `cybervinci.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de cybervinci en su organización.
