---
title: Supporto ACP
description: Usa CYBERVINCI in qualunque editor compatibile con ACP.
---

CYBERVINCI supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare CYBERVINCI via ACP, configura l'editor in modo che esegua il comando `cybervinci acp`.

Il comando avvia CYBERVINCI come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'CYBERVINCI' nel selettore agenti di AI Chat.
...
Per usare CYBERVINCI come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare CYBERVINCI come agente ACP per la chat.
...
CYBERVINCI funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione CYBERVINCI
