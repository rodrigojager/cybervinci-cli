...
Crea `.cybervinci/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di CYBERVINCI o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di CYBERVINCI:
...
- Globale: `~/.config/cybervinci/commands/`
- Per progetto: `.cybervinci/commands/`
...
cybervinci include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
