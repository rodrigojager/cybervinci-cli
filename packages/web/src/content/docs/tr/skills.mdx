...
Ajan becerileri, cybervinci'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
cybervinci su konumlari tarar:

- Proje konfigurasyonu: `.cybervinci/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/cybervinci/skills/<name>/SKILL.md`
...
Proje yerel yollarinda cybervinci, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.cybervinci/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/cybervinci/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.cybervinci/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
cybervinci, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`cybervinci.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`cybervinci.json` icinde):
