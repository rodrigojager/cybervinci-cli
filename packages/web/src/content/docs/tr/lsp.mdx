...
description: CYBERVINCI, LSP sunucularınızla bütünleşir.
---

CYBERVINCI, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

CYBERVINCI, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`CYBERVINCI_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP etkinleştirildiğinde ve cybervinci bir dosyayı açtığında:
...
LSP sunucularını, cybervinci yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
