...
`.cybervinci/commands/test.md` oluştur:
...
cybervinci işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

cybervinci [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/cybervinci/commands/`
- Proje başına: `.cybervinci/commands/`
...
cybervinci, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
