---
title: Paylasim
description: cybervinci konusmalarini genel baglantilarla paylasin.
---

cybervinci'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda cybervinci:
...
cybervinci, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak cybervinci manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `cybervinci.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda cybervinci kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
