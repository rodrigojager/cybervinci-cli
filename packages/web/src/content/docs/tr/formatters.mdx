...
description: cybervinci dile özgü biçimlendiriciler kullanır.
---

cybervinci, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

cybervinci, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, cybervinci bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

cybervinci bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri cybervinci yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
