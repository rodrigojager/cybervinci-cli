---
title: Özel Araçlar
description: LLM'un cybervinci'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. cybervinci'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.cybervinci/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/cybervinci/tools/` içine yerleştirerek.
