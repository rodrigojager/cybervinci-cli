...
description: Verwenden Sie CYBERVINCI in jedem ACP-kompatiblen Editor.
---

CYBERVINCI unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um CYBERVINCI über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `cybervinci acp`.

Der Befehl startet CYBERVINCI als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „CYBERVINCI“ in der AI Chat Agent Selector.
...
Um CYBERVINCI als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass CYBERVINCI als ACP-Agent für den Chat verwendet wird.
...
CYBERVINCI funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer CYBERVINCI-Konfiguration konfiguriert sind
