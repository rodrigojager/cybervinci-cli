...
Erstellen Sie `.cybervinci/commands/test.md`:

```md title=".cybervinci/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die CYBERVINCI-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CYBERVINCI [config](/docs/config):

```json title="cybervinci.jsonc" {4-12}
{
...
- Global: `~/.config/cybervinci/commands/`
- Pro Projekt: `.cybervinci/commands/`

```markdown title="~/.config/cybervinci/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".cybervinci/commands/component.md"
---
...
```md title=".cybervinci/commands/create-file.md"
---
...
```md title=".cybervinci/commands/analyze-coverage.md"
---
...
```md title=".cybervinci/commands/review-changes.md"
---
...
```md title=".cybervinci/commands/review-component.md"
---
...
CYBERVINCI enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
