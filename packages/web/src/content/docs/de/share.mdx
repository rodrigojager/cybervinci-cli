---
title: Teilen
description: Teile CYBERVINCI-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CYBERVINCI-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CYBERVINCI Folgendes:
...
CYBERVINCI hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CYBERVINCI den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`cybervinci.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du cybervinci in deiner Organisation einsetzt.
