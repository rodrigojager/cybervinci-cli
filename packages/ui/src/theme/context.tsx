...
const STORAGE_KEYS = {
  THEME_ID: "cybervinci-theme-id",
  COLOR_SCHEME: "cybervinci-color-scheme",
  THEME_CSS_LIGHT: "cybervinci-theme-css-light",
  THEME_CSS_DARK: "cybervinci-theme-css-dark",
} as const
