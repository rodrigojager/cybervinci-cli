...
Schema-first LLM core for cybervinci. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@cybervinci-ai/llm"
import { OpenAI } from "@cybervinci-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@cybervinci-ai/llm/providers"
