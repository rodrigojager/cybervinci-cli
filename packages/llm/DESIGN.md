...
> current private `@cybervinci-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@cybervinci-ai/ai`
...
- Secondary audience: CYBERVINCI and other durable agent runtimes
...
import { LLM } from "@cybervinci-ai/ai"
import { OpenAI } from "@cybervinci-ai/ai/providers/openai"
...
```ts
import { Message } from "@cybervinci-ai/ai"
...
import { LLM, Tool } from "@cybervinci-ai/ai"
...
CYBERVINCI and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@cybervinci-ai/ai/promise"
import { OpenAI } from "@cybervinci-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@cybervinci-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@cybervinci-ai/ai/provider"
...
@cybervinci-ai/ai/promise
  Promise/AsyncIterable LLM facade

@cybervinci-ai/ai/schema
  serializable domain schemas

@cybervinci-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@cybervinci-ai/ai/providers/openai
@cybervinci-ai/ai/providers/anthropic
@cybervinci-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@cybervinci-ai/llm`                      | `@cybervinci-ai/ai`                                           |
...
CYBERVINCI should migrate to `generateTurn` / `streamTurn`, preserving its durable
