...
import type { Plugin as PluginRuntime } from "@cybervinci-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/Plugin") {}
