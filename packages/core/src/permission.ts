...
export { Effect, Rule, Ruleset } from "@cybervinci-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/Permission") {}
