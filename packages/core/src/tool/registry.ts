...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@cybervinci-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/ToolRegistry") {}
