...
import { FileSystemWatcher } from "@cybervinci-ai/schema/filesystem-watcher"
...
declare const CYBERVINCI_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CYBERVINCI_LIBC === "undefined" ? undefined : CYBERVINCI_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CYBERVINCI_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CYBERVINCI_EXPERIMENTAL_FILEWATCHER)) {
