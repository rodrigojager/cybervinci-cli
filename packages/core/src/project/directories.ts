...
import type { EffectDrizzleSqlite } from "@cybervinci-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/ProjectDirectories") {}
