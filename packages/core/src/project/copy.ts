...
import { Event } from "@cybervinci-ai/schema/project-directories"
import { ProjectCopy } from "@cybervinci-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/ProjectCopy") {}
