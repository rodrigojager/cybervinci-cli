...
import { ListAnchor } from "@cybervinci-ai/schema/session"
...
import { SessionDurable } from "@cybervinci-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/Session") {}
