...
import { Entry, FileSystem, FindInput, Match } from "@cybervinci-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@cybervinci-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/FileSystem") {}
