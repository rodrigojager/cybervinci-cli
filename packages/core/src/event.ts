...
import type { Data, Definition, Payload } from "@cybervinci-ai/schema/event"
...
import { Durable } from "@cybervinci-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@cybervinci-ai/schema/event").ID
export type { Data, Definition, Payload } from "@cybervinci-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/Event") {}
