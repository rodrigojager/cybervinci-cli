...
import { PermissionSaved } from "@cybervinci-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@cybervinci/v2/PermissionSaved") {}
