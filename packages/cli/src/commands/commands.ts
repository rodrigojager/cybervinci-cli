...
declare const CYBERVINCI_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CYBERVINCI_CLI_NAME === "string" ? CYBERVINCI_CLI_NAME : "opencode", {
  description: "CYBERVINCI 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
