...
// "cybervinci-desktop". Keep that hidden desktop entry around so existing GNOME/KDE
// pins still resolve after the canonical app id changes back to ai.cybervinci.desktop.
...
const getBase = (appId: string): Configuration => ({
  artifactName: "cybervinci-desktop-${os}-${arch}.${ext}",
  directories: {
    output: "dist",
    buildResources: "resources",
  },
  // Linux launchers are .desktop files, so this is the desktop file name,
  // not just the app id. For prod, app id "ai.cybervinci.desktop" becomes
  // "ai.cybervinci.desktop.desktop".
