export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの CYBERVINCI を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCI のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'cybervinci' コマンドを使用してください。",
