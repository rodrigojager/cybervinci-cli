export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo CYBERVINCIn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCIn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää CYBERVINCIn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'cybervinci'-komentoa.",
