export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من CYBERVINCI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من CYBERVINCI، هل ترغب في تثبيته وإعادة تشغيله؟",
