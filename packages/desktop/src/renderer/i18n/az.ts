export const dict = {
  ...
  "desktop.updater.none.message": "Artıq CYBERVINCI-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCI-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
