export const dict = {
  ...
  "desktop.updater.none.message": "CYBERVINCI-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCI-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'cybervinci' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
