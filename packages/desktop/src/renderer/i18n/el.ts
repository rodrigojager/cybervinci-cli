export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του CYBERVINCI",
  ...
  "desktop.cli.installed.message":
    "CLI εγκατεστημένο στο {{path}}\n\nΕπανεκκινήστε το τερματικό σας για να χρησιμοποιήσετε την εντολή 'cybervinci'.",
