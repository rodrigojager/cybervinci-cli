export const dict = {
  ...
  "desktop.updater.none.message": "Már az CYBERVINCI legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az CYBERVINCI {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'cybervinci' parancs használatához.",
