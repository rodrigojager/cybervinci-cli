export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք CYBERVINCI-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCI-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
