export const dict = {
  ...
  "desktop.updater.none.message": "CYBERVINCI'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCI'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'cybervinci' komutunu kullanmak için terminalinizi yeniden başlatın.",
