export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van CYBERVINCI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van CYBERVINCI is gedownload. Wil je deze installeren en CYBERVINCI opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'cybervinci' te gebruiken.",
