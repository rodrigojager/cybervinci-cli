export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon CYBERVINCI ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "CYBERVINCIning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'cybervinci' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
