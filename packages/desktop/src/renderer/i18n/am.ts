export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCYBERVINCI ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCYBERVINCI ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
