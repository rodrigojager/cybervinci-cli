...
const releaseId = process.env.CYBERVINCI_RELEASE
if (!releaseId) throw new Error("CYBERVINCI_RELEASE is required")

const version = process.env.CYBERVINCI_VERSION
if (!version) throw new Error("CYBERVINCI_VERSION is required")
...
const macxTarGz = "cybervinci-desktop-mac-x64.app.tar.gz"
const macaTarGz = "cybervinci-desktop-mac-arm64.app.tar.gz"
