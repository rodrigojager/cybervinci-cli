...
Generates UPCOMING_CHANGELOG.md by running the cybervinci changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for cybervinci run (default: low)
      --quiet            Suppress cybervinci command output unless it fails
