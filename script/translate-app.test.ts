...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".cybervinci/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".cybervinci/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".cybervinci/glossary/zh-tw.md")
  })
