...
- `CYBERVINCI` (preserve casing in prose; keep `cybervinci` only when it is part of commands, package names, paths, or code)
- `OpenCode Zen`
- `CYBERVINCI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `cybervinci` in prose when referring to the product name; use `CYBERVINCI`
