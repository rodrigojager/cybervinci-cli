...
- `CYBERVINCI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `cybervinci` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CYBERVINCI` in prose, `cybervinci` only for exact technical identifiers
...
- Avoid changing `cybervinci` to `CYBERVINCI` inside commands, URLs, package names, or code literals
